 ...
 */
  ...
  //#define X_DUAL_ENDSTOPS           // X2 has its own endstop
    ...
    #if defined(PROBE_1) || defined(PROBE_11)
      #define X2_USE_ENDSTOP _XMAX_  // X2 endstop board plug. Don't forget to enable USE_*_PLUG.
    #endif
    #if defined(PROBE_2) || defined(PROBE_21)
      #define X2_USE_ENDSTOP _XMIN_  // X2 endstop board plug. Don't forget to enable USE_*_PLUG.
    #endif
...
/**
 * PROBoter-specific settings and commands
 */
#if ENABLED(PROBOTER)
  // The pin used for electrical probe centering
  #define PROBOTER_PROBE_CENTERING_PIN P0_17
  // The clearing height in z in mm while probing
  #define PROBOTER_Z_CLEARANCE 1
  // The inital probing step in x/y in mm
  #define PROBOTER_PROBING_STEP 1
  // Probing speed in mm/min
  #define PROBOTER_PROBING_SPEED 1000

  // Light configuration
  #if ENABLED(PROBE_1)
    #define PROBOTER_IS_LIGHT_CONTROLLER
  #endif
  // The light control pin
  #define PROBOTER_LIGHT_CONTROL_PIN HEATER_BED_PIN
#endif

/**
 * PROBoter test PCB-specific settings
 */
#if ENABLED(PROBOTER) && ENABLED(USE_PROBOTER_TEST_PCB)
  // The number of pads
  #define PROBOTER_TEST_PCB_NUM_PADS 16
  // Shift clock pin
  #define PROBOTER_TEST_PCB_PIN_SCLK P1_23
  // Latch clock pin
  #define PROBOTER_TEST_PCB_PIN_LC P1_22
  // Parallel load pin
  #define PROBOTER_TEST_PCB_PIN_PL P1_21
  // Output enable pin
  #define PROBOTER_TEST_PCB_PIN_OE P1_20
  // Data output pin
  #define PROBOTER_TEST_PCB_PIN_DO P1_18
  // Testpad connection pin
  #define PROBOTER_TEST_PCB_PIN_TESTPADS P1_19
#endif
