 ...
 * 
 *** PROBoter ***
 * M370 - Perform 4-point pin centering
 * M371 - Read evaluation PCB status
 * M375 - Test if board is light controller
...
private:
  ...
  static void M220();
    ...
    // Center probe
    static void M370();
    #if ENABLED(USE_PROBOTER_TEST_PCB)
      // Read evaluation PCB status
      static void M371();
    #endif
