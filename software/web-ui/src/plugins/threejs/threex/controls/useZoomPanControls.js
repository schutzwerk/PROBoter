...
export default function ZoomPanControls(object, domElement) {
  this.object = object;
  ...
  var pan = (function () {
    ...
    return function (deltaX, deltaY) {
      ...
      if (scope.object instanceof THREE.PerspectiveCamera) {
        ...
        console.warn(
          "WARNING: ZoomPanControls.js encountered an unknown camera type - pan disabled."
        );
  ...
  function dollyIn(dollyScale) {
    if (scope.object instanceof THREE.PerspectiveCamera) {
      ...
      console.warn(
        "WARNING: ZoomPanControls.js encountered an unknown camera type - dolly/zoom disabled."
      );
      scope.enableZoom = false;
    }
  }
