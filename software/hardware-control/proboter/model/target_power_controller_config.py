...
class TargetPowerControllerConfig(Entity):
    """
    Configuration for a target power controller / switch box
    """
    # Id of the UART interface adapter
    id: int = fields.IntField(pk=True)
    # The baud rate to use to send data
    baud_rate: int = fields.IntField(null=False, default=115200)
    ...
    proboter: fields.OneToOneRelation["ProboterConfig"] = fields.OneToOneField("models.ProboterConfig",
                                                                               related_name="target_power_controller",
                                                                               null=False)
